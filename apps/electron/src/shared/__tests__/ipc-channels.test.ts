...
const EXPECTED_CHANNELS: string[] = [
  ...
  'statuses:list',
  'statuses:reorder',
  'stockResearch:addWatchlistItem',
  'stockResearch:createRun',
  'stockResearch:getReport',
  'stockResearch:listReports',
  'stockResearch:listWatchlistItems',
  'stockResearch:removeWatchlistItem',
  'stockResearch:saveReport',
  'stockResearch:updateWatchlistItem',
  'system:homeDir',
  'system:isDebugMode',
  'system:versions',
  'tasks:getOutput',
